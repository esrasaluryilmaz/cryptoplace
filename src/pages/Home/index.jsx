...
const Home = () => {
  //Context yapisi icerisinden verileri al
  const { allCoin } = useContext(CoinContext);

  console.log(allCoin);

  //Bilesen ekrana geldiginde displayCoini in degerini apiden gelen tum coinler olarak ata
  useEffect(() => {
  ...
  const searchHandler = (e) => {
    ...
    //Inputtan girilen coin adina gore tum coinler arasinda filtreleme yap
  ...
  const inputHandler = (e) => {
    //Deger degistiginde inputa yeni degeri ata.
  ...
  return (
    <div className="px-4">
      {/*Top */}
      <div className="max-w-2xk mx-auto my-16 flex flex-col items-center gap-6">
